...
# @param margins margin space surrounding the plots, default is lines based, 0.1 for top and right and -0.99 for bottom and left
...
# @param colpairs list information generated by ggcolpairs to produce the matrix
# @param ... not used
# @keywords print
...
# @param colpairs list information generated by ggcolpairs containing the properties of the matrix
# @param ... not used
# @keywords misc
